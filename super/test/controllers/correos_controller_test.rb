...
class CorreosControllerTest < ActionController::TestCase
  ...
  test "should create correo" do
    assert_difference('Correo.count') do
      post :create, correo: { departamento: @correo.departamento, mensaje: @correo.mensaje, remitente: @correo.remitente }
    end
  ...
  test "should update correo" do
    patch :update, id: @correo, correo: { departamento: @correo.departamento, mensaje: @correo.mensaje, remitente: @correo.remitente }
    assert_redirected_to correo_path(assigns(:correo))
  end
