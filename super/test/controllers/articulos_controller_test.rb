...
class ArticulosControllerTest < ActionController::TestCase
  ...
  test "should create articulo" do
    assert_difference('Articulo.count') do
      post :create, articulo: { descripcion: @articulo.descripcion, precio: @articulo.precio, tags: @articulo.tags }
    end
  ...
  test "should update articulo" do
    patch :update, id: @articulo, articulo: { descripcion: @articulo.descripcion, precio: @articulo.precio, tags: @articulo.tags }
    assert_redirected_to articulo_path(assigns(:articulo))
  end
